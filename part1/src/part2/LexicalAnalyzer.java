package part2;/* The following code was generated by JFlex 1.7.0 */
...
class LexicalAnalyzer {
   ...
   * @exception   java.io.IOException  if any I/O-Error occurs
   */
  public part1.Symbol nextToken() throws java.io.IOException {
    int zzInput;
    int zzAction;
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        zzAtEOF = true;
          { 		return new part1.Symbol(part1.LexicalUnit.END_OF_STREAM, yyline, yycolumn, yytext());
 }
      }
      else {
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { return new part1.Symbol(part1.LexicalUnit.VARNAME, yyline, yycolumn, yytext());
            } 
            // fall through
          case 32: break;
          case 2: 
            { return new part1.Symbol(part1.LexicalUnit.NUMBER, yyline, yycolumn, yytext());
            } 
            // fall through
          case 33: break;
          case 3: 
          ...
          case 34: break;
          case 4: 
            { return new part1.Symbol(part1.LexicalUnit.EQUAL, yyline, yycolumn, yytext());
            } 
            // fall through
          case 35: break;
          case 5: 
            { return new part1.Symbol(part1.LexicalUnit.PLUS, yyline, yycolumn, yytext());
            } 
            // fall through
          case 36: break;
          case 6: 
            { return new part1.Symbol(part1.LexicalUnit.MINUS, yyline, yycolumn, yytext());
            } 
            // fall through
          case 37: break;
          case 7: 
            { return new part1.Symbol(part1.LexicalUnit.TIMES, yyline, yycolumn, yytext());
            } 
            // fall through
          case 38: break;
          case 8: 
            { return new part1.Symbol(part1.LexicalUnit.DIVIDE, yyline, yycolumn, yytext());
            } 
            // fall through
          case 39: break;
          case 9: 
            { return new part1.Symbol(part1.LexicalUnit.LPAREN, yyline, yycolumn, yytext());
            } 
            // fall through
          case 40: break;
          case 10: 
            { return new part1.Symbol(part1.LexicalUnit.RPAREN, yyline, yycolumn, yytext());
            } 
            // fall through
          case 41: break;
          case 11: 
            { return new part1.Symbol(part1.LexicalUnit.SEMICOLON, yyline, yycolumn, yytext());
            } 
            // fall through
          case 42: break;
          case 12: 
            { return new part1.Symbol(part1.LexicalUnit.GREATER, yyline, yycolumn, yytext());
            } 
            // fall through
          case 43: break;
          case 13: 
            { return new part1.Symbol(part1.LexicalUnit.SMALLER, yyline, yycolumn, yytext());
            } 
            // fall through
          case 44: break;
          case 14: 
            { return new part1.Symbol(part1.LexicalUnit.ASSIGN, yyline, yycolumn, yytext());
            } 
            // fall through
          case 45: break;
          case 15: 
            { return new part1.Symbol(part1.LexicalUnit.IF, yyline, yycolumn, yytext());
            } 
            // fall through
          case 46: break;
          case 16: 
            { return new part1.Symbol(part1.LexicalUnit.TO, yyline, yycolumn, yytext());
            } 
            // fall through
          case 47: break;
          case 17: 
            { return new part1.Symbol(part1.LexicalUnit.DO, yyline, yycolumn, yytext());
            } 
            // fall through
          case 48: break;
          case 18: 
            { return new part1.Symbol(part1.LexicalUnit.BY, yyline, yycolumn, yytext());
            } 
            // fall through
          case 49: break;
          case 19: 
            { return new part1.Symbol(part1.LexicalUnit.FOR, yyline, yycolumn, yytext());
            } 
            // fall through
          case 50: break;
          case 20: 
            { return new part1.Symbol(part1.LexicalUnit.END, yyline, yycolumn, yytext());
            } 
            // fall through
          case 51: break;
          case 21: 
            { return new part1.Symbol(part1.LexicalUnit.NOT, yyline, yycolumn, yytext());
            } 
            // fall through
          case 52: break;
          case 22: 
            { return new part1.Symbol(part1.LexicalUnit.FROM, yyline, yycolumn, yytext());
            } 
            // fall through
          case 53: break;
          case 23: 
            { return new part1.Symbol(part1.LexicalUnit.THEN, yyline, yycolumn, yytext());
            } 
            // fall through
          case 54: break;
          case 24: 
            { return new part1.Symbol(part1.LexicalUnit.ELSE, yyline, yycolumn, yytext());
            } 
            // fall through
          case 55: break;
          case 25: 
            { return new part1.Symbol(part1.LexicalUnit.READ, yyline, yycolumn, yytext());
            } 
            // fall through
          case 56: break;
          case 26: 
            { return new part1.Symbol(part1.LexicalUnit.ENDIF, yyline, yycolumn, yytext());
            } 
            // fall through
          case 57: break;
          case 27: 
            { return new part1.Symbol(part1.LexicalUnit.WHILE, yyline, yycolumn, yytext());
            } 
            // fall through
          case 58: break;
          case 28: 
            { return new part1.Symbol(part1.LexicalUnit.PRINT, yyline, yycolumn, yytext());
            } 
            // fall through
          case 59: break;
          case 29: 
            { return new part1.Symbol(part1.LexicalUnit.BEG, yyline, yycolumn, yytext());
            } 
            // fall through
          case 60: break;
          case 30: 
            { return new part1.Symbol(part1.LexicalUnit.ENDFOR, yyline, yycolumn, yytext());
            } 
            // fall through
          case 61: break;
          case 31: 
