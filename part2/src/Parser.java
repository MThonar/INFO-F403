...
public class Parser {
    ...
    public void syntax_error(Symbol token) throws Exception {
        throw new Exception("0: Syntax error at line " + token.getLine() + " generated by the token " + token.getValue());
    }
    
    public void syntax_error1(Symbol token) throws Exception {
        throw new Exception("1: Syntax error at line " + (token.getLine()+1) + " generated by the token " + token.getValue());
    }
}
