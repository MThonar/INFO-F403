...
public class Parser {
    ...
    /**
     * This function builds a list that contains only the interesting symbols for the AST
     */
    ...
    /**
     * This function pre-processes a parse tree in order to build a list
     * with all the symbols from the parse tree
     * @param parseTree
     * @param listToBuild
     */
     ...
     * This functions allows to take the operations priority into account
     */
    ...
    /**
     * This function allows to build a list which contains alle the tokens of an exprArith
     */
    ...
    /**
     * This function creates the AST, using all the methods previously documented
     */
